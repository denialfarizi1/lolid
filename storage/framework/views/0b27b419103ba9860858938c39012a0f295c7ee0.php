            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="alert alert-success">
                        <center><p>Silahkan cek Email anda untuk ativasi akun</p></center>
                        </div>
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group<?php echo e($errors->has('hp') ? ' has-error' : ''); ?>">
                            <label for="hp" class="col-md-4 control-label">hp +62</label>

                            <div class="col-md-6">
                                <input id="hp" type="number" class="form-control" name="hp" value="<?php echo e(old('hp')); ?>" required autofocus>
                                <i style="font-size: 8px;color: blue;">*maximmal 10 angka</i>
