...
<!-- Bootstrap style --> 
    ...
    <link id="callCss" rel="stylesheet" href="<?php echo e(asset('bootstrap4/bootstrap.min.css')); ?>" media="screen"/>
    
<!-- Bootstrap style responsive --> 
    <link href="<?php echo e(asset('../themes/css/bootstrap-responsive.min.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('bootstrap4/bootstrap.css')); ?>" rel="stylesheet"/>
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="home"><img src="../themes/images/logo.jpg" alt="Bootsshop" style="width: 140px; height: 41px;" /></a>
        ...
        <input id="srchFld" class="srchTxt" type="text" name="name" placeholder="      cari user disini" style="width: 120px" />
        ...
        <ul id="sideManu" class="nav nav-tabs nav-stacked">
            ...
            <a href=""><li class="subMenu">Grup anda
               <ul style="display:block;">
                ...
                <li><a href="<?php echo e($gl->grup_id); ?>"><i class="icon-chevron-right"></i><?php echo e($gl->grup_name); ?></a></li>
