...
<div style="min-height: 400px; width: 520px;  border: 1px solid; ">
    <div class="container" >
...
<div class="mfooter_center_chat">
       <div style="width: 100%; height: 40px; border: 0px solid; float: left;">
              ...
              <input type="hidden" name="asal" value="<?php echo e('mmessage_'.$message_id); ?>">
              ...
              <input class="btn btn-primary btn-medium" type="submit" value="chat">
              </div>
              </form>
   ...
   <a href="" data-toggle="modal" data-target="#post_status"><div style="width: 18%; float: left;"><img src="themes/images/post_status.png" class="img-circle" style="width: 25px;"></div></a>
...
<div class="modal-dialog" role="document" style="width: 450px;">
  <div class="modal-content" style="width: 430px;">
    <div class="modal-body" style="width: 420px; height: 120px;">
        <div style="width: 400px; height: 100px; border: 1px solid; border-color: blue; padding: 5px;">
