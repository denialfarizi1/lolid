...
<div class="container" style="width: 520px;">
    <div class="row">
        ...
        <div class="col-md-8">
            <form action="<?php echo e('/produk/update/'.$produk_id->produk_id); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                         ...
                         <div class="col-sm-5">
                            ...
                            <input class="form-control" id="#" type="hidden" name="produk_id" value="<?php echo e($produk_id->produk_id); ?>" placeholder="">
                         </div>
                </div>
                ...
                <div class="form-group">
                         ...
                         <div class="col-sm-5">
                            <input class="form-control" id="#" type="hidden" name="user_id" value="<?php echo e($produk_id->user_id); ?>" placeholder="" >
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Nama Produk</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_name" value="<?php echo e($produk_id->produk_name); ?>" style="width: 300px;">
                         </div>
                </div>
                 <div class="form-group">
                    <label class="col-sm-5 control-label">Lokasi</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_lokasi" value="<?php echo e($produk_id->produk_lokasi); ?>" style="width: 300px;">
                         </div>
                </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                    <label class="col-sm-5 control-label">Merek</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_brand"  value="<?php echo e($produk_id->produk_brand); ?>" style="width: 200px;">
                         </div>
                </div>
                 <div class="form-group">
                    <label class="col-sm-5 control-label">Model</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_model" style="width: 200px;" value="<?php echo e($produk_id->produk_model); ?>">
                         </div>
                </div>
                 <div class="form-group">
                    <label class="col-sm-5 control-label">Tanggal Released</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="date" name="produk_released_on" style="width: 200px;" value="<?php echo e($produk_id->produk_released_on); ?>">
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Dimensi P x L x T</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_dimensions" style="width: 200px;" value="<?php echo e($produk_id->produk_dimensions); ?>">
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Ukuran Tersedia</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="text" name="produk_size" style="width: 200px;" value="<?php echo e($produk_id->produk_size); ?>">
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Descripsi</label>
                         <div class="col-sm-5">
                            <textarea name="produk_desc" style="width: 500px; height: 300px;" ><?php echo $produk_id->produk_desc; ?></textarea>
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Stock</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="number" name="produk_qty" style="width: 200px;" value="<?php echo e($produk_id->produk_qty); ?>">
                         </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">Harga</label>
                         <div class="col-sm-5">
                            <input class="form-control" type="number" name="produk_price" style="width: 200px;" value="<?php echo e($produk_id->produk_price); ?>">
                         </div>
                </div>
                <!--
                <div class="form-group">
