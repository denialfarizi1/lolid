   ...
   <div style="width: 480px; height: auto; border:1px solid; border-color: red;  padding: 4px;">
       ...
       <div style="width: 480px; height: 40px; border: 0px solid;">
          ...
          <a href="<?php echo e('=@'.$p->username); ?>">
            ...
            <img src="<?php echo e(url('image_user/view/'.$p->image_profil)); ?>" class="img-circle" style="width: 35px; height: 35px; float: left; padding: 5px;">
            <?php else: ?>
          ...
          <a href="<?php echo e('=@'.$p->username); ?>">
           <h6 style="height: 12px; margin: 0px; padding-top: 5px;" ><?php echo e($p->name); ?> 
         ...
         <?php endif; ?>
         <center>
          <form  method="post" action="pencarian=m=text=<?php echo e($limit_tambah+20); ?>" >
          <?php echo e(csrf_field()); ?>
