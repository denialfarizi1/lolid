...
<div class="span7" style="width: 520px; border: 1px solid; font-size: 13px;">
  ...
  <h3 style="padding-right: 40px;"> <?php if(!empty($produk_jenis)): ?>
      <?php echo e($produk_jenis->produk_jenis); ?>
  ...
  <div class="tab-pane" id="listView">
    ...
    <div class="row">   
      ...
      <div style="width: 200px; height: 150px; overflow: hidden; margin: 0px;">
        <a href="produk_<?php echo e($val->produk_id); ?>"><img src="<?php echo e(url('image/view/'.$val->produk_image_src1)); ?>" style="width: 100% ;  display: block; height: 100%;  margin: 0px;" /></a>
      </div>
