            ...
            <form action="<?php echo e('/produk/update/'.$produk_id->produk_id); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-sm-10 control-label">Nama Produk</label>
                         <div class="col-sm-10">
                            <input class="form-control" type="text" name="produk_name" value="<?php echo e($produk_id->produk_name); ?>" >
                         </div>
                </div>
                 <div class="form-group">
                    <label class="col-sm-10 control-label">Lokasi</label>
                         <div class="col-sm-10">
                            <input class="form-control" type="text" name="produk_lokasi" value="<?php echo e($produk_id->produk_lokasi); ?>" >
                         </div>
                </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                    <label class="col-sm-10 control-label">Merek</label>
                         <div class="col-sm-10">
                            <input class="form-control" type="text" name="produk_brand" style="width: 200px;" value="<?php echo e($produk_id->produk_brand); ?>">
                         </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-10 control-label">Descripsi</label>
                         <div class="col-sm-10">
                            <textarea name="produk_desc" style="width: 700px;"><?php echo $produk_id->produk_desc; ?></textarea>
                         </div>
                </div>
                <div class="form-group">
