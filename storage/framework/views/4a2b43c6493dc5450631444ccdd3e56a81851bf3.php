...
<div class="span7" style="width: 520px; border: 0px solid; font-size: 13px;">
  ...
  <h4>  Detail Produk Anda [ <small><?php echo e($count_produk_user); ?> Item(s) </small>]</h4>  
 ...
 <?php if(!empty($user_produk_post)): ?>
  ...
  <table class="table table-bordered" style="font-size: 10px;">
              ...
              <tbody>
                <tr>
                  <td><center><div style="width: 60px;"><img width="40" src="<?php echo e(url('image/view/'.$val->produk_image_src1)); ?>" alt=""/></br><?php echo e($val->produk_name); ?></div></center></td>
                  
                  <td><center><div style="width: 50px;"><?php echo e($val->produk_model); ?></div></center></td>
                  <td><center><div style="width: 80px;"><?php echo e($val->produk_size); ?></div></center></td>
                  <td><center><?php echo e($val->produk_qty); ?></center></td>
                  <td><center>Rp.<?php echo e($val->produk_price); ?>,00</center></td>
                  <td><center>
                      <div style="width: 120px;">
                        <div style="float: left; padding-right: 2px;">
                             <a href="medit_produk_<?php echo e($val->produk_id); ?>"><button style="font-size: 10px" type="button" class="btn btn-success btn-mini">edit </button></a>
                        </div>
                       <div style="float: left; padding-right: 2px;">
                           <a href="mproduk_<?php echo e($val->produk_id); ?>"><button style="font-size: 10px" type="button" class="btn btn-info btn-mini"> detail</button></a>
                        </div>
