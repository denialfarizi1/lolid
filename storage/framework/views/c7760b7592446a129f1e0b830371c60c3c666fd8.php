...
<div style="width: 495px; height: auto; border: 0px solid; padding: 2px; ">
  <center><a href="<?php echo e('image_user/view/'.Auth::user()->image_background); ?>">
    <div style="width: 490px; height: 290px; border: 0px solid;  padding: 1px; <?php if(!empty(Auth::user()->image_background)): ?> background: url(<?php echo e('image_user/view/'.Auth::user()->image_background); ?>); <?php else: ?> background: url('themes/images/profil_background.jpg'); <?php endif; ?> background-size: 490px; background-repeat: no-repeat; background-position: center;">  
            ...
            <div style="width: 480px; height: 70px; border: 0px solid; border-color: blue; padding: 4px;">
               <div style="width: 80px; height: 70px; float: left; border: 0px solid; border-color: blue; padding: 4px;">
                ...
                <a href="<?php echo e('image_user/view/'.Auth::user()->image_profil); ?>"><img style="width: 70px; height: 70px; border:0px solid;" src="<?php echo e(url('image_user/view/'.Auth::user()->image_profil)); ?>"/></a>
                  <?php else: ?>
     ...
     <div style="width: 480px; border: 0px solid; clear: left;">
        <div style="width: 200px; border: 0px solid; float: left; text-align: left;">
                  ...
                  <div style="font-size: 10px; padding-left: 10px;">@<i><?php echo e(Auth::user()->username); ?></i></div>
        </div>
  ...
  <div class="tab-pane" id="produk">
       ...
       <div style="width: 120px; height: 90px; overflow: hidden">        
        ...
        <div class="caption">
           ...
           <div style="text-align:center" ><a class="btn btn-primary btn-mini" >Rp.<?php echo e($val->produk_price); ?>,00</a>
           </div>
     ...
     <div class="tab-pane" id="catatan">
         <div style="width: 460px; height: auto; border: 0px solid; border-color: yellow;">
           ...
           <div style="width: 450px; height: auto; border: 0px solid; float: left; padding: 5px;">
             ...
             <div>
               <h6 style="border: 0px solid;"><img src="themes/images/blog.png" style="width: 20px; height: 20px;"><?php echo e($c->catatan_judul); ?></h6>
               ...
               <div style="width: 250px; height: 40px; border: 0px solid;">
                  ...
                  <div style="width: 200px; height: 40px; border: 0px solid; padding-top: 4px; float: left; font-size: 13px;">
                    <div style="height: 15px; font-size: 13px;">
                      <a href="<?php echo e('@'.$fr->get_follower_user->username); ?>" style="padding: 0px; margin: 0px;"><b>
                      <?php echo e($fr->get_follower_user->name); ?></b></a>
                  ...
                  <p><small><i>@</i></small><small><i><?php echo e($fr->get_follower_user->username); ?></i></small></p>
                  </div> 
                  </div>
                </div>
            </td>
            ...
            <tr>
              <td>
                  <div style="width: 250px; height: 40px; border: 0px solid;">
                      ...
                      <a href="<?php echo e('@'.$fd->get_followed_user->username); ?>">
                      <h6 style="height: 12px; border: 0px solid; padding: 0px; margin: 0px; " ><?php echo e($fd->get_followed_user->name); ?>
                      ...
                      <div style="height: 11px; font-size: 11px; padding: 0px; margin: 0px;">
                          <p><small><i>@</i></small><small><i><?php echo e($fd->get_followed_user->username); ?></i></small></p>
                      </div>
                      </div>
                  </div>
            </td>
        ...
        <table style="font-size: 11px;">
          ...
          <tr>
            ...
            <td><div style="padding-top: 10px;">
              <input type="text" name="name" value="<?php echo e(Auth::user()->name); ?>" style="height: 12px;">
               </div>
            </td>
          </tr>
          <tr>
            ...
            <td>:</td>
            <td><div style="padding-top: 10px;"> 
              <input type="email" name="email" value="<?php echo e(Auth::user()->email); ?>" style="height: 12px;">
                </div>
            </td>
          </tr>
          <tr>
            ...
            <td>:</td>
            <td><div style="padding-top: 10px;">
              <input type="number" name="hp" value="0<?php echo e(Auth::user()->hp); ?>" style="height: 12px;">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td><div style="padding-top: 20px;">
              <textarea name="desc" style="width: 300px;"><?php echo e(Auth::user()->desc); ?></textarea>
                </div>
            </td>
          </tr>
          <tr>
            ...
            <td>:</td>
            <td><div style="padding-top: 10px;">
              <input type="text" name="alamat" value="<?php echo e(Auth::user()->alamat); ?>" style="width: 320px; height: 12px;"/>
                </div>
            </td>
          </tr>
          <tr>
