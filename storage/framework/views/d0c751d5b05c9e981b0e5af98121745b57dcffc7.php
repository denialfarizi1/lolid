      ...
      <?php 
       ...
       ?>
        <div style="width: 80px; float: left; padding: 5px;">
            <button class="btn btn-success btn-mini" data-toggle="modal" data-target=".admin"><b > Admin [<?php echo e($count_grup_public_admin); ?>]</b></button>
        </div>
        <!-- Modal admin -->
          ...
          <td>
              <div style="width: 250px; height: 50px; border: 0px solid;">
                  ...
                  <div style="width: 200px; height: 40px; border: 0px solid; padding-top: 4px;">
                      ...
                      <p><small><i>@</i></small><small><i><?php echo e($gpu->get_grup_public_admin->username); ?></i></small></p>
                      </div>
                      </h5>
                      </a>
                  </div>
...
<!--end admin -->
        <div style="width: 80px; float: left; padding: 5px;">
            <button class="btn btn-success btn-mini" data-toggle="modal" data-target=".anggota"><b > Anggota [<?php echo e($count_grup_public_user); ?>]</b></button>
        </div>
...
<div class="modal fade" id="comment<?php echo e($post_id); ?>" tabindex="-1" role="dialog" aria-labelledby="comment" aria-hidden="true" style="width: 440px; border: 0px solid;">
  <div class="modal-dialog" role="document">
...
<!--end modul -->
           <!-- Modal share-->
                                          <div style="padding-top: 0px; ">
                                            <div class="modal fade" id="share<?php echo e($post_id); ?>" tabindex="-1" role="dialog" aria-labelledby="share" aria-hidden="true" style="width: 440px; ">
                  ...
                  <div style="width: 150px; height: 40px; border: 0px solid; padding-top: 4px; float: left;">
                      <a href="<?php echo e('@'.$gpu->get_grup_public_anggota->username); ?>">
                          <h5 style="margin: 4px;" ><?php echo e($gpu->get_grup_public_anggota->name); ?>
                            ...
                            <?php endif; ?>
                      <div style="font-size: 13px;">
                      <p><small><i>@</i></small><small><i><?php echo e($gpu->get_grup_public_anggota->username); ?></i></small></p>
                      </div>
                      </h5>
                      </a>
                  </div>
               ...
               <div style="width: 180px; height: 50px; border: 1px solid;">
                  <div style="width: 40px; height: 50px; border: 0px solid; float: left;">
                      <a href="<?php echo e('@'.$fr->get_follower_user->username); ?>">
                        ...
                        <img src="<?php echo e(url('image_user/view/'.$fr->get_follower_user->image_profil)); ?>" class="img-circle" style="width: 40px; height: 40px; float: left; padding: 2px;">
                          <?php else: ?>
                  ...
                  <div style="width: 180px; height: 50px; border: 0px solid;">
                      <div style="width: 40px; height: 50; border: 0px solid; float: left">
                          <a href="<?php echo e('@'.$fd->get_followed_user->username); ?>">
                            ...
                            <img src="<?php echo e(url('image_user/view/'.$fd->get_followed_user->image_profil)); ?>" class="img-circle" style="width: 40px; height: 40px; float: left; padding: 2px;">
                              <?php else: ?>
                               <img src="themes/images/profil.jpg" class="img-circle" style="width: 40px; height: 40px; float: left; padding: 2px;">
                              <?php endif; ?>
                          </a>
