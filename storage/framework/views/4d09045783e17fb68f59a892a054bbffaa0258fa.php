<?php $__env->startSection('content'); ?>
  ...
  <h3>  SHOPPING CART [ <small><?php echo e($count_cart); ?> Item(s) </small>]<a href="produk" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>  
  <hr class="soft"/>
  ...
  <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e($c->produk_cart_qty); ?>

                    
                  </td>
                  <td>Rp.<?php echo e($c->produk_price); ?>,00</td>
                  <td>Rp.,00</td>
                  <td><a href="edit_cart_produk_<?php echo e($c->cart_id); ?>"><button type="button" class="btn btn-success btn-xs">edit </button></a>
                      </form>
    ...
    function total() {
    var qty = 75000 * parseInt(document.getElementById('produk_price').value);
