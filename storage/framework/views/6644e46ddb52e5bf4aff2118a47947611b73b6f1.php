...
location.replace("'https://lolid.xyz/=@'.$user_id->username");
}
               ...
               <ul style="display:block;">
                <?php if(!empty($grup_list)): ?>
                     ...
                     <div style="width: auto; height: auto;">
                       <li><a href="<?php echo e('group_'.$gl->grup_id); ?>"><i class="icon-chevron-right"></i><i><img src="themes/images/ico-bumi.png" style="width: 15px; height: 15px;"></i><?php echo e($gl->grup_name); ?><img src="themes/images/ico-chat.jpg" style="width: 15px; height: 15px; padding-left: 5px;" >
