            ...
            <div class="carousel-inner">
              ...
              <ul class="thumbnails">
                ...
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_{{$val->user_id}}"><img src="{{url('image/view/'.$val->produk_image_src1)}}" alt=""></a>
                    <div class="caption">
                      <h5>{{$val->produk_name}}</h5>
                      <h4><center><a class="btn" href="produk_{{$val->produk_id}}">VIEW</a></center> 
                        <center><span class="btn btn-primary"">Rp.{{$val->produk_price}},00</span></center></h4>
                    </div>
                  </div>
                </li>
                      @endforeach
                ...
                <li class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <center><a class="btn btn-primary" href="#">Rp.{{$val->produk_price}},00</a></center>
                    </div>
                  </div>
                </li>
                @endforeach
