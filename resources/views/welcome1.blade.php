...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    @else
          <li><a href="user_produk_{{Auth::user()->id}}" ><button class="btn btn-success">Produk Anda</button></a></li>
          <li>
                                <a href="profil_user" style="padding-right: 0px; padding-left: 0px;">
                                    <button class="btn btn-success" >{{ Auth::user()->name }}</button>
                                </a>
          </li>      
          <li><a href="profil_user" style="padding-right: 0px; padding-left: 5px;"><img class="img-circle" style="width:40px;" src="{{url('image/view/'.Auth::user()->image_profil)}}" alt=""/></a></li>
            ...
            <div class="carousel-inner">
              ...
              <ul class="thumbnails">
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/b1.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Hight Hill Spesial</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.35.000,-</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/b2.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Hight Hill Limited</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.29.000,-</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/b3.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Hight Hill Blue Sky</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.24.000,-</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/b4.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Hight Hill Black Forest</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.19.000,00</span></h4>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <ul class="thumbnails">
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/5.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera E60 Pro</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.89.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                  <i class="tag"></i>
                    <a href="produk_1"><img src="themes/images/products/6.jpg" alt=""></a>
                    <div class="caption">
                      <h5>SanDisk</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.59.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/7.jpg" alt=""></a>
                    <div class="caption">
                      <h5>SD Cart 8 GB</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.19.000.00</span></h4>
                    </div>
                ...
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/8.jpg" alt=""></a>
                    <div class="caption">
                      <h5>SanDisk 16GB</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.29.000,00</span></h4>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <ul class="thumbnails">
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/9.jpg" alt=""></a>
                    <div class="caption">
                      <h5>1 Set Kamera Pro</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.89.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/10.jpg" alt=""></a>
                    <div class="caption">
                      <h5>SanDisk 8GB SDHC</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.18.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/11.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera Fujifilm 32MBP</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.35.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/1.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera Fujifilm 64MBP</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.39.000,-</span></h4>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <ul class="thumbnails">
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/2.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera Nikon 75MBP</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.45.000,-</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/3.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera Lumix 84MBP</h5>
                      <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.46.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/4.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamera FujiFilm 89MBP</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">Rp.47.000,00</span></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a href="produk_1"><img src="themes/images/products/5.jpg" alt=""></a>
                    <div class="caption">
                      <h5>Kamre FujiFilm 100MBP</h5>
                       <h4><a class="btn" href="produk_1">VIEW</a> <span class="pull-right">RP.49.000,00</span></h4>
                    </div>
                  </div>
                </li>
              </ul>
                ...
                <li class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp.19.000,00</a></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      <h5>Micro SD 36GB</h5>
                      <p> 
                        1 Set Micro SD model terbaru. 
                      </p>
                     <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp.18.000,00</a></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a  href="produk_1"><img src="themes/images/products/8.jpg" alt=""/></a>
                    <div class="caption">
                      <h5>SanDIsk Extrime 16GB</h5>
                      <p> 
                        Kecepatan 45MB/s. 
                      </p>
                       <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp.17.000,00</a></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a  href="produk_1"><img src="themes/images/products/9.jpg" alt=""/></a>
                    <div class="caption">
                      <h5>Set Kamera FujiFilm 64MBP</h5>
                      <p> 
                         Memory 8GB + Bateray + Tas Cantik. 
                      </p>
                      <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">RP.49.000.00</a></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
                    </div>
                  </div>
                </li>
                <li class="span3">
                  <div class="thumbnail">
                    <a  href="produk_1"><img src="themes/images/products/11.jpg" alt=""/></a>
                    <div class="caption">
                      <h5>Kamera FujiFilm Pro</h5>
                      <p> 
                        Kamera 84MBP. 
                      </p>
                       <h4 style="text-align:center"><a class="btn" href="produk_1"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp.44.000,00</a></h4>
                    </div>
                  </div>
                </li>
              </ul> 
