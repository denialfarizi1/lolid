...
<body style="background: url({{'themes/images/banner3.jpg'}}); width: 520px; border: 0px solid;">

<div id="header" style="background: url({{'themes/images/banner3.jpg'}}); width: 520px; ; border: 0px solid;">
<div class="container" >
    ...
    @else
      <div style="width: 300px; height: 50px; border: 0px solid; float: right;">
          ...
          <div style="width: auto; float: right; padding-top: 0px; font-size: 8px; padding-top: 0px;">
            <a href="profil"><button class="btn btn-success btn-mini">{{ Auth::user()->name }}</button></a>
          </div>
