  ...
  <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <input type="number" name="produk_cart_qty" id="harga_algoritma" value="{{$c->produk_cart_qty}}" style="width: 30px" onchange="total()">
                  </td>
                   
                  <td>{{$c->produk_price}}</td>
                  ...
                  <td><a href="/cart_produk/update"><button type="submit" class="btn btn-success btn-xs">update </button></a>
                      ...
                      <a href="produk_{{$c->produk_id}}"><button type="button" class="btn btn-info btn-xs"> detail</button></a>
                      <a href="/cart_produk/hapus/{{$c->cart_id}}"><button type="button" class="btn btn-danger btn-xs"> delete</button></a>
                  </td>
                  </form> 
                </tr>
                   @endforeach
