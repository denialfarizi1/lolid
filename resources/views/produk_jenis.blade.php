...
<div class="tab-content">
  <div class="tab-pane" id="listView">
    ...
    <div class="row">   
      <center>  
      <div class="span3">
        <a href="produk_{{$val->produk_id}}"><img src="{{url('image/view/'.$val->produk_image_src1)}}" style="width: 120px ;  display: block; height: 120px;  margin: 0px;" /></a>
      </div>
  ...
  <div class="tab-pane  active" id="blockView" style="padding-left: 5px;">
    <ul class="thumbnails">
      ...
      <center>
        ...
        <form action="cari_barang={{$limit_tambah+24}}" method="POST">
           {{ csrf_field() }}
