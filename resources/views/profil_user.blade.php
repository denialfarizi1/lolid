...
<div style="width: 780px; height: auto; border:1px solid; float: left; padding: 5px; ">
  <center><a href="{{'image_user/view/'.Auth::user()->image_background}}">
    <div style="width: 720px; height: 390px; border: 0px solid;  padding: 4px; @if(!empty(Auth::user()->image_background)) background: url({{'image_user/view/'.Auth::user()->image_background}}); @else background: url('themes/images/profil_background.jpg'); @endif background-size: 722px; background-repeat: no-repeat; background-position: center;">  
            ...
            <div style="width: 710px; height: 90px; border:0px solid; border-color: blue; padding: 4px;">
               <div style="width: 140px; height: 90px; float: left; border:0px solid; border-color: blue; padding: 4px;">
                ...
                <a href="{{'image_user/view/'.Auth::user()->image_profil}}"><img style="width:90px; height: 90px; border:0px solid;" src="{{url('image_user/view/'.Auth::user()->image_profil)}}"/></a>
                  @else
     ...
     <div style="width: 720px; border: 0px solid; clear: left;">
        <div style="width: 165px; border: 0px solid; float: left;">
                  ...
                  <div style="font-size: 10px; padding-right: 20px;">@<i>{{Auth::user()->username}}</i></div>
        </div>
